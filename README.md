...
It is actively used in **monthly internal performance review meetings** with the Platform Owner, Ops Manager, Finance Lead, Promotion Coordinator, and Payment Channel Coordinator to support strategic decisions and performance improvements.
...
To evaluate monthly performance, we track three primary KPIs:  
- **Total Deposit**  
- **Total Withdrawal**  
...
- **Python**: Used Pandas to clean character encoding adjustments to ensure clean, compliant data for SQL processing.
